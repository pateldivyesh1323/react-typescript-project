...
const useCartContext = (initCartState:CartStateType)=>{
    ...
    const totalPrice = new Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(state.cart.reduce((prev,cartItem)=>{return prev+(cartItem.price*cartItem.qty)},0))
